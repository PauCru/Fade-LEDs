...
void loop()
{
  ...
  analogWrite(led5, 10);    // posar PWM del pin 11 a 125
  ...
  analogWrite(led4, 10);    // posar PWM del pin 10 a 255
  analogWrite(led5, 60);    // posar PWM del pin 11 a 255
  ...
  analogWrite(led1, 0);    // posar PWM del pin 5 a 125
  analogWrite(led2, 0);    // posar PWM del pin 6 a 125
  analogWrite(led3, 10);    // posar PWM del pin 9 a 125
  ...
  analogWrite(led0, 0);    // posar PWM del pin 3 a 125
  analogWrite(led1, 0);    // posar PWM del pin 5 a 125
  analogWrite(led2, 10);    // posar PWM del pin 6 a 125
  analogWrite(led3, 60);    // posar PWM del pin 9 a 125
  analogWrite(led4, 125);    // posar PWM del pin 10 a 125
  analogWrite(led5, 200);    // posar PWM del pin 11 a 125
  
  delay(velocitat);           // es queden leds velocitat ms en aquest estat

  analogWrite(led0, 0);    // posar PWM del pin 3 a 125
  analogWrite(led1, 10);    // posar PWM del pin 5 a 125
  analogWrite(led2, 60);    // posar PWM del pin 6 a 125
  analogWrite(led3, 125);    // posar PWM del pin 9 a 125
  analogWrite(led4, 200);    // posar PWM del pin 10 a 125
  analogWrite(led5, 255);    // posar PWM del pin 11 a 125
  
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  
  analogWrite(led0, 10);    // posar PWM del pin 3 a 125
  analogWrite(led1, 60);    // posar PWM del pin 5 a 125
  analogWrite(led2, 125);    // posar PWM del pin 6 a 125
  analogWrite(led3, 200);    // posar PWM del pin 9 a 125
  ...
  analogWrite(led1, 125);    // posar PWM del pin 5 a 125
  analogWrite(led2, 200);    // posar PWM del pin 6 a 125
  ...
  analogWrite(led0, 125);    // posar PWM del pin 3 a 125
  analogWrite(led1, 200);    // posar PWM del pin 5 a 125
  ...
  analogWrite(led0, 200);    // posar PWM del pin 3 a 125
